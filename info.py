...
# =========================================================
# Mandatory Channels
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1003558208911'))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1003558208911'))

# Feature Specific Logs
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1003558208911'))
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1003558208911'))
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003558208911"))

# Auth Channels (Safe Parsing)
auth_channel_str = environ.get("AUTH_CHANNEL", "-1003558208911")
...
if not URL or URL == "/":
    URL = "hissing-nonnah-prajwal0027-9748d40b.koyeb.app/"
